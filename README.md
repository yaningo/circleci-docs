...
This is the public repository for [CircleCI Docs](https://circleci.com/docs/) which consists of:
- a static website generated by [Jekyll](https://jekyllrb.com/) 
- tooling that builds our api documentation ([Slate](https://github.com/slatedocs/slate) and [Widdershins](https://github.com/Mermade/widdershins)). 

If you find any errors in our docs or have suggestions, please follow our [Contributing Guide](./docs/CONTRIBUTING.md) to submit an issue or pull request.
...
For larger edits or new articles, you'll want to set up a local environment for editing. Please see our [Local Development README](./docs/README-local-development.md) to set that up.
...
Docs for CircleCI Server Administration are built in a slightly different way so there is a [separate README](./docs/README-server-docs.md) for this section.

Other information about the repo can be found in the [docs folder](./docs).
...
Everything in this repository not covered above is licensed under the [included MIT license](./docs/LICENSE).
